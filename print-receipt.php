...
<body>
	...
	<div class="col-lg-8">
		...
		<a href="out-vehicles.php"><button class="btn btn-primary">Vissza</button></a>
		<?php
        $cid=$_GET['vid'];
      ...
      <table id="dom-jqry" class="table table-striped table-bordered">
        <tr>
          <th colspan="4" style="text-align: center; font-size:22px;"> Jármű parkolás adatok</th>
        </tr>
      ...
      <?php if($row['Remark']!=""){ ?>
      <tr>
        <th>Parkoloból távozás időpontja</th>
