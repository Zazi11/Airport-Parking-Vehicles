		...
		<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Jelentések</div>
                        ...
                        <form method="POST" enctype="multipart/form-data" name="datereports" action="generate-reports.php">
                            ...
                            <div class="panel-body">
                                ...
                                <em class='fa fa-lg fa-close'>
                                    ...
                                    <center><button type="submit" class="btn btn-primary" name="submit">Jelentés készítése</button></center>
