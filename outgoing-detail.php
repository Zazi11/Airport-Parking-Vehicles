					...
					<div class="panel panel-default">
                        ...
                        <div class="col-md-12">
                            ...
                            ?> 
                                ...
                                <div class="form-group">
									<label>Teljes fizetett összeg</label>
									<input type="text" class="form-control" value="Ft <?php  echo $row['ParkingCharge'];?>" id="parkingcharge" name="parkingcharge" readonly>
								</div>
